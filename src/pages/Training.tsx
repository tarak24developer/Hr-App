    ...
    <div className="space-y-6 p-4 sm:p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <DashboardCard
          ...
          value={courses.reduce((total, course) => total + course.enrolledCount, 0)}
          icon={Users}
          color="green"
        />
        <DashboardCard
            ...
            <div className="bg-white rounded-lg shadow-xl max-w-3xl w-full max-h-[85vh] overflow-y-auto z-[210]">
              <div className="p-4">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start space-x-4 p-4 bg-gray-50 rounded-lg">
                    ...
                    <div className="flex-1">
                      <h4 className="text-xl font-semibold text-gray-900">{viewingCourse.title}</h4>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                            ...
                            <p className="text-sm text-gray-600">{viewingCourse.title}</p>
                          </div>
                        </div>
                        <div className="flex items-center space-x-3">
                    ...
                    <div>
                            ...
                            <p className="text-sm text-gray-600">{viewingCourse.instructor}</p>
                          </div>
                        </div>
                        <div className="flex items-center space-x-3">
                    ...
                    <div>
                            ...
                            <p className="text-sm text-gray-600">{viewingCourse.category}</p>
                          </div>
                        </div>
                        <div className="flex items-center space-x-3">
                    ...
                    {/* Course Details */}
                    <div className="space-y-4">
                      <h5 className="text-lg font-medium text-gray-900 border-b border-gray-200 pb-2">Course Details</h5>
                      <div className="space-y-3">
                        <div className="flex items-center space-x-3">
                          <div className="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center">
                    ...
                    <div>
                            ...
                            <p className="text-sm text-gray-600">{viewingCourse.duration}</p>
                          </div>
                        </div>
                        <div className="flex items-center space-x-3">
                          <div className="w-8 h-8 bg-green-100 rounded-full flex items-center justify-center">
                    ...
                    <div>
                            <p className="text-sm font-medium text-gray-900">Max Capacity</p>
                            <p className="text-sm text-gray-600">{viewingCourse.maxCapacity}</p>
                          </div>
                        </div>
                        <div className="flex items-center space-x-3">
                          <div className="w-8 h-8 bg-purple-100 rounded-full flex items-center justify-center">
                    ...
                    <div>
                            ...
                            <p className="text-sm text-gray-600">{viewingCourse.startDate}</p>
                    </div>
                  </div>
                        <div className="flex items-center space-x-3">
                          <div className="w-8 h-8 bg-orange-100 rounded-full flex items-center justify-center">
                ...
                <div>
                            ...
                            <p className="text-sm text-gray-600">{viewingCourse.endDate}</p>
                          </div>
                        </div>
                      </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <h5 className="text-lg font-medium text-gray-900 border-b border-gray-200 pb-2">Enrollment Information</h5>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-3">
                        <div className="flex justify-between">
                          <span className="text-sm font-medium text-gray-500">Currently Enrolled</span>
                          <span className="text-sm text-gray-900">{viewingCourse.enrolledCount}</span>
                    </div>
                        <div className="flex justify-between">
                  ...
                  {/* Description Section */}
                  <div className="space-y-4">
                    <h5 className="text-lg font-medium text-gray-900 border-b border-gray-200 pb-2">Course Description</h5>
                    <div className="p-3 bg-gray-50 rounded-lg">
                      <p className="text-sm text-gray-900">{viewingCourse.description}</p>
                    </div>
                  </div>
                </div>
